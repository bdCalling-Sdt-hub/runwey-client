...
import { OccasionsData } from "../../../ReduxSlices/OccasionsSlice";
...
const Occasions = () => {
  ...
  const data = useSelector((state) => state.OccasionsData.OccasionsList);
      ...
      >
        <div className="flex flex-col">
              ...
              {selectedFiles ? (
                <>
                  <div className="mt-[-35px] ">
                    <div
                      onClick={(e) => setSelectedFiles(null)}
                      className="absolute self-end  right-[320px] bg-white rounded-full  cursor-pointer"
                    >
                      <svg
                ...
                <>
                  ...
                  <div
                    ...
                    className="z-10 w-[120px] cursor-pointer h-9 p-2.5 bg-violet-700 rounded-lg justify-center items-center gap-2.5 inline-flex"
                  >
          ...
          <div className="border-secondary p-[30px] rounded-2xl border-[1px] ">
            ...
            <div onClick={handleAddOccasion} className="cursor-pointer">
