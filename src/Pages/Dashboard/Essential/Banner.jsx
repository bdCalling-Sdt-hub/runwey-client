            ...
            {selectedFiles ? (
              <>
                <div className="relative">
                  <div
                    ...
                    className="absolute self-end top-2 right-2 bg-white rounded-full  cursor-pointer"
                  >
                    <svg
              ...
              <>
                <div
                  ...
                  className="flex justify-center items-center flex-col mt-[32px] gap-4 my-auto h-[400px]"
                >
                  <svg
                    width="50"
                    height="50"
